...
public class CovariantList<T1, T2, T3, T4, T5> : Internal.ListAggregator<T1, T2, T3, T4, T5>, IList<T5>, ICollection<T5>, IList, ICollection, IReadOnlyList<T5>, IReadOnlyCollection<T5>, IEnumerable<T5>, IEnumerable
    where T2 : T1
    where T3 : T2
    where T4 : T3
    where T5 : T4
