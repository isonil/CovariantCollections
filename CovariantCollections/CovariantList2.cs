...
public class CovariantList<T1, T2> : Internal.ListAggregator<T1, T2>, IList<T2>, ICollection<T2>, IList, ICollection, IReadOnlyList<T2>, IReadOnlyCollection<T2>, IEnumerable<T2>, IEnumerable
    where T2 : T1
{
